...
async function run() {
	...
	while (true) {
		await page.goto('https://secure.newegg.ca/NewMyAccount/AccountLogin.aspx', { waitUntil: 'networkidle0' })
	...
	while (true) {
		try {
			await page.goto('https://secure.newegg.ca/Shopping/AddtoCart.aspx?Submit=ADD&ItemList=' + config.item_number, { waitUntil: 'networkidle0' })
